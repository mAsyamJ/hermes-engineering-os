...
from agent_os.registry.inventory import inventory_skills
from agent_os.registry.schema import validate_skill_entry
...
def build_registry(hermes_home: Path | None = None) -> dict[str, Any]:
    ...
    if not expanded_path.exists():
        try:
            from agent_os.registry.ingest.github import write_expanded_cache

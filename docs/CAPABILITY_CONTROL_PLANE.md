...
Canonical ADR: [ADR-HERMES-AGENT-OS.md](ADR-HERMES-AGENT-OS.md).
...
./scripts/agent-os-verify.sh
PYTHONPATH=/opt/hermes-engineering-os \
  /home/ubuntu/.hermes/hermes-agent/venv/bin/python -c 'from agent_os.generate import regenerate; print(regenerate())'

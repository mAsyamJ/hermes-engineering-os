...
(`docs/reference/REAL_EXPERIMENT_BUDGET.md`). Reply phrase:
...
`scripts/deployment/h2-write-authorization.sh`.

Present HARD vs SOFT vs UNAVAILABLE with
`scripts/deployment/h2-present-budget.sh`. After authorization,

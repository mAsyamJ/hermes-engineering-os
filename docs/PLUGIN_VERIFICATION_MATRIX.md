...
| engineering-os 1.0.0 | PASS | PASS | PASS side-effect-free | PASS | PASS GET-only including `/analytics*` | PASS live (Observability + Analytics) | PASS guarded | VERIFIED |
...
stay GET-only; sidecar outage is DEGRADED, not a Hermes failure.

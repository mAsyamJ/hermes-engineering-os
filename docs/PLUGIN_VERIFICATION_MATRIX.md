...
| engineering-os 1.0.0 | PASS | PASS | PASS side-effect-free | PASS | PASS GET-only including `/analytics*`, `/evaluations*`, and `/performance*` | PASS live (Observability + Analytics + Evaluations + Performance) | PASS guarded | VERIFIED |

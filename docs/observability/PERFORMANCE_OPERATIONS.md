...
oneshot `scripts/observability/performance-materialize.sh --json`. Advisory lock
...
Manual: `scripts/observability/performance-materialize.sh --dry-run --json` then without

...
`scripts/deployment/pag2-as-runtime.sh pag2-probe`. Evidence-gated shadow:
`scripts/deployment/pag2-shadow.sh` → `python -m engineering_os.adaptation pag2-shadow`.

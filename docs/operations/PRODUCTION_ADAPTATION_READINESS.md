...
Machine dashboard: `scripts/deployment/pag2-status.sh`. Shadow/canary/rollback probes
...
`scripts/deployment/pag2-bind-canary.sh` (hermes-op) to persist the CANARY binding.

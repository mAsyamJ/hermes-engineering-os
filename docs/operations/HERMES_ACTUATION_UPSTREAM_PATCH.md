...
See `docs/operations/HERMES_UPSTREAM_DELTA_AUDIT.md` and `docs/operations/HERMES_UPSTREAM_PR_READY.md`.
...
(see `docs/operations/HERMES_LIVE_PATCH.md`). Do not apply any of these to live

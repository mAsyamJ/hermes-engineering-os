...
See `docs/evaluation/EVALUATION_SEMANTICS.md` and `docs/evaluation/EVALUATION_CAPABILITY_MATRIX.md`.
...
| `scripts/verification/verify.sh` | PASS including live Evaluations view |

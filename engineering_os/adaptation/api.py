    ...
    payload.update(
        {
            ...
            "cells": {
                ...
                "upstream_actuation": cells.get("upstream_actuation"),
                "memory_isolation": cells["memory_isolation"],
                "real_experiment_preflight": cells.get("real_experiment_preflight"),
                "budget_authorization": cells.get("budget_authorization"),
                "real_experiment": cells.get("real_experiment"),
                "treatment_fidelity": cells.get("treatment_fidelity"),
                "real_causal_evidence": cells["real_causal_evidence"],
                "production_recommendation": cells.get("production_recommendation"),
                "pag2_readiness": cells.get("pag2_readiness"),

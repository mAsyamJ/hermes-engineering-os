...
install -m 0755 -o root -g hermes-op "$ROOT/scripts/deployment/hermes-eos-deploy-tool.py" \
  /usr/local/lib/hermes-eos/hermes-eos-deploy-tool.py
install -d -m 0755 -o root -g hermes-op /usr/local/lib/hermes-eos/scripts
install -m 0755 -o root -g hermes-op "$ROOT/scripts/verification/verify-operator-boundary.sh" \
  /usr/local/lib/hermes-eos/scripts/verify-operator-boundary.sh
install -m 0644 -o root -g hermes-op "$ROOT/scripts/deployment/pag2-inspect-ubuntu.sh" \
...
"$ROOT/scripts/deployment/h1-postcheck.sh" || true
...
echo "Do not claim PASS until scripts/verification/verify-operator-boundary.sh prints status=PASS"
